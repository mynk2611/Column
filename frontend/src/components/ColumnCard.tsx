                ...
                <Link to={`/column/${id}`}>
                    <div className="flex justify-between">
                        ...
                        <div className="relative">
                            ...
                            {isDropdownOpen && (
                                <div>
                                    <div className="absolute top-7 h-3 w-3 left-1/2 -translate-x-1/2 translate-y-2 rotate-45 bg-white shadow-[rgba(0,0,15,0.5)_-1px_1px_20px_0.2px] " />
                                    <div className="absolute top-10 -translate-x-20 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 z-10">
